...
/*global weinreUrl, loadResources, loadPolyfills, loadingCallback, debug, allCookies, unescape */
...
(function(argument) {
  ...
  if (!window.apiUrl) {
    ...
    if(allCookies.appbuilder_locale){
      dojoConfig.locale = allCookies.appbuilder_locale.toLowerCase();
    }
    ...
    if (window.apiUrl.substr(this.length - 'arcgis-js-api/'.length, 'arcgis-js-api/'.length) ===
      'arcgis-js-api/') {
